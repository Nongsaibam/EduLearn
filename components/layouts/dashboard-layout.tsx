...
export function DashboardLayout({ children, role = "student" }: DashboardLayoutProps) {
  ...
  return (
    <div className={cn("min-h-screen bg-background", darkMode && "dark")}>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 flex h-full w-64 flex-col bg-sidebar transition-transform duration-300 lg:translate-x-0",
      ...
      >
        ...
        <div className="border-t border-sidebar-border p-4">
          <Link
            href="/chatbot"
            className="flex items-center gap-3 rounded-lg bg-sidebar-accent px-3 py-2.5 text-sm font-medium text-sidebar-foreground transition-colors hover:bg-sidebar-accent/80"
          >
